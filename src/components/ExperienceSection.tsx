...
const journey: RouteStop[] = [
  {
    ...
    organization: 'TECHNOCRATS HORIZONS COMPUSOFT PVT. LTD.',
    description: 'Own three AI-native SaaS products from zero to production, leading a cross-functional team of nine while authoring PRDs, agent architecture, and release management end to end.',
  },
  {
    id: '02',
    year: 'APR - OCT 2025',
    title: 'INDEPENDENT PRODUCT CONSULTANT',
    organization: 'FREELANCE, HYDERABAD',
    description: 'Advised early-stage SaaS teams on product discovery and backlog structure while completing IBM’s Agentic AI certification and building agent-based prototypes hands-on.',
  },
  {
    id: '03',
    year: 'MAR 2022 - MAR 2025',
    title: 'SENIOR BUSINESS ANALYST / TACTICAL PRODUCT OWNER',
    organization: 'VIVID MINDS TECHNOLOGIES PVT. LTD. (QUIXY)',
    description: 'Owned and prioritised the product backlog for a no-code workflow automation platform, led sprint planning, and drove stakeholder adoption through enablement and documentation.',
  },
  {
    id: '04',
    year: 'OCT 2018 - MAR 2022',
    title: 'BUSINESS ANALYST',
    organization: 'UNEECOPS TECHNOLOGY LTD.',
    description: 'Delivered requirements for two state-scale student-lifecycle e-governance platforms, running JAD sessions, BRDs, and the requirement traceability matrix.',
  },
  {
    id: '05',
    year: 'JUL 2014 - APR 2016',
    title: 'ASSOCIATE BUSINESS ANALYST',
    organization: 'CAMP SYSTEMS PVT. LTD.',
    description: 'Wrote SRS documentation and built Axure prototypes for a regulated aircraft maintenance system, contributing to Airbus Corporate Jets and Boeing Business Jets accounts.',
  },
  {
    id: '06',
    year: '2026',
