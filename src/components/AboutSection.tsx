        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative mb-6 select-none">
              <h2
                className="text-4xl sm:text-6xl md:text-7xl lg:text-[5.4rem] tracking-tight uppercase leading-[0.88]"
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Bhavani Prasad Koppala</span>, an AI Product Owner with 10 years across product ownership and business analysis. I currently own three products at once — a live 3D SaaS customizer, a live multi-agent enterprise analytics platform, and an eight-agent outbound sales automation system — leading a nine-person delivery team while building working prototypes myself with LLM tooling, n8n orchestration, and AI-assisted development.
            </motion.p>
            ...
            >
              ...
              <div className="relative overflow-hidden w-full max-w-[390px] aspect-[4/5] bg-black rounded-sm">
                ...
                <div className="absolute bottom-4 right-4 z-20 select-none">
                  <span
                    className="text-xl whitespace-nowrap text-[#F2D8A7] drop-shadow-[0_0_12px_rgba(242,216,167,0.5)] transition-colors duration-300 group-hover:text-white"
