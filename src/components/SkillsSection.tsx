...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Multi-Agent Orchestration', 'Prompt Engineering', 'n8n Cloud', 'Google AI Studio', 'Ollama', 'Tripo AI', 'FAL.AI', 'RAG'],
    description: 'Scoping multi-agent systems, defining agent roles, confidence thresholds, and human-in-the-loop guardrails. AI-assisted development with Cursor, Claude, and Lovable.',
    stat: '3 AI PRODUCTS LIVE',
    colSpan: 'lg:col-span-7',
  },
  {
    title: 'PRODUCT & DELIVERY',
    badge: 'LEADERSHIP',
    items: ['Jira', 'Confluence', 'Trello', 'Scrum', 'Kanban', 'Waterfall'],
    description: 'PRDs, epics, user stories, acceptance criteria, sprint planning, backlog grooming, UAT, and release management for a nine-person delivery team.',
    stat: '9-PERSON TEAM',
  ...
  },
  {
    ...
    badge: 'DISCOVERY',
    items: ['Figma', 'Axure', 'Balsamiq', 'Edraw', 'No-Code Platforms'],
    description: 'ICP and persona definition, opportunity sizing, competitive analysis, and reviewable wireframes and interactive prototypes.',
    stat: 'SPEC TO PROTOTYPE',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'DATA, ANALYTICS & PLATFORM',
    badge: 'FOUNDATIONS',
    items: ['Power BI', 'Tableau', 'SQL', 'Postgres', 'MySQL', 'BigQuery', 'Snowflake', 'Next.js', 'React', 'Node.js', 'WebGL/WebXR'],
    description: 'North-star and guardrail metric design, unified connector layers across five data sources, and SaaS foundations — RBAC, multi-tenancy, audit logging, credential encryption.',
    stat: '5+ CONNECTORS',
    colSpan: 'lg:col-span-7',
  },
];
